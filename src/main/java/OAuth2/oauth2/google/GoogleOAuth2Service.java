...
public class GoogleOAuth2Service {
    ...
    public GoogleLoginDTO getUserInfo(HttpServletRequest request) throws JsonProcessingException {
    ...
    public GoogleResponseDTO authByGoogleCode(HttpServletRequest request) throws JsonProcessingException {
    ...
    public GoogleLoginDTO getGoogleUserInfo(GoogleResponseDTO googleLoginResponse) throws JsonProcessingException {
