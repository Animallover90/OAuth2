...
public class KakaoLoginService {
    ...
    public KakaoLoginDTO getUserInfo(String code) throws JsonProcessingException {
    ...
    public KakaoLoginDTO getUserInfoByToken(String token) throws JsonProcessingException {
        HttpHeaders httpHeaders = new HttpHeaders();
